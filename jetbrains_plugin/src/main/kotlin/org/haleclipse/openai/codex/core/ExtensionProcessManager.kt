...
import org.haleclipse.openai.codex.util.ProxyConfigUtil
import java.io.File
import java.util.concurrent.TimeUnit
import org.haleclipse.openai.codex.util.ExtensionUtils
import org.haleclipse.openai.codex.util.PluginConstants
import org.haleclipse.openai.codex.util.NotificationUtil
import org.haleclipse.openai.codex.util.NodeVersionUtil
import org.haleclipse.openai.codex.util.NodeVersion
...
//                "--trace-uncaught",
    ...
    fun findExtensionEntryFile(): String? {
        ...
        // Normal mode
        val resourcesPath = org.haleclipse.openai.codex.util.PluginResourceUtil.getResourcePath(PLUGIN_ID, "$RUNTIME_DIR/$EXTENSION_ENTRY_FILE")
        if (resourcesPath != null) {
