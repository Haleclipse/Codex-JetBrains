...
import org.haleclipse.openai.codex.theme.ThemeManager.Companion.getDefaultThemeResourceDir
import org.haleclipse.openai.codex.theme.ThemeManager.Companion.getThemeResourceDir
...
class VsixManager {
    ...
    private fun getPluginThemesDirectory(): File? {
        return try {
            ...
            val pluginThemesPath = org.haleclipse.openai.codex.util.PluginResourceUtil.getResourcePath(
                org.haleclipse.openai.codex.util.PluginConstants.PLUGIN_ID,
                "themes"
            )
    ...
    fun getExtensionResourcePath(
        ...
        try {
            val pluginPath = org.haleclipse.openai.codex.util.PluginResourceUtil.getResourcePath(
                org.haleclipse.openai.codex.util.PluginConstants.PLUGIN_ID,
                codeDir
            )
