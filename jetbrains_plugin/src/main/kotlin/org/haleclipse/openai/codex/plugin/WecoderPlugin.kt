...
package org.haleclipse.openai.codex.plugin
...
import org.haleclipse.openai.codex.core.ExtensionProcessManager
import org.haleclipse.openai.codex.core.ExtensionSocketServer
import org.haleclipse.openai.codex.core.ServiceProxyRegistry
import org.haleclipse.openai.codex.webview.WebViewManager
import org.haleclipse.openai.codex.workspace.WorkspaceFileChangeManager
...
import org.haleclipse.openai.codex.core.*
...
import org.haleclipse.openai.codex.util.ExtensionUtils
...
class WecoderPluginService(private var currentProject: Project) : Disposable {
    ...
    companion object {
        // Debug mode switch
        @Volatile
        private var DEBUG_TYPE: DEBUG_MODE = org.haleclipse.openai.codex.plugin.DEBUG_MODE.NONE
...
//                ServiceProxyRegistry.getInstance().initialize()
                ...
                if (DEBUG_TYPE == org.haleclipse.openai.codex.plugin.DEBUG_MODE.ALL) {
    ...
    private fun cleanup() {
        try {
            ...
            if (DEBUG_TYPE == org.haleclipse.openai.codex.plugin.DEBUG_MODE.NONE) {
                processManager.stop()
            }
        } catch (e: Exception) {
